...
namespace ES3Editor
{
	public class ToolsWindow : SubWindow
	{
        ...
        [MenuItem("Tools/Easy Save 3/Clear Cache Files", false, 200)]
        private static void ClearCacheFiles()
        {
	        if (EditorUtility.DisplayDialog("Clear Cache Files", "Are you sure you wish to clear all es3 cache files?\nThis action cannot be reversed.", "Clear", "Cancel"))
		        ES3.ClearCacheFiles();
        }
    }
